...
<div class="col-lg-2 d-none d-lg-block p-0">
    <div class="shadow p-3 d-flex flex-column position-fixed h-100 w-inherit">
        ...
        <ul class="nav nav-pills d-block mb-auto">
            <!-- home -->
            <li class="nav-item">
                <a href="admin-panel.php" class="nav-link d-flex gap-2 align-items-center <?= $page == 'home' ? 'active': 'text-black'; ?>">
            ...
            <!-- users -->
            <li class="nav-item">
                <a href="./admin-panel.php?page=user" class="nav-link d-flex gap-2 align-items-center <?= $page == 'user' ? 'active': 'text-black'; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <!-- posts-->
            <li class="nav-item">
                <a href="admin-panel.php?page=post" class="nav-link d-flex gap-2 align-items-center <?= $page == 'post' ? 'active': 'text-black'; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
            ...
            <!-- category-->
            <li class="nav-item">
                <a href="admin-panel.php?page=category" class="nav-link d-flex gap-2 align-items-center <?= $page == 'category' ? 'active': 'text-black'; ?>">
            ...
            <!-- comments -->
            <li class="nav-item">
                <a href="admin-panel.php?page=comment" class="nav-link d-flex gap-2 align-items-center <?= $page == 'comment' ? 'active': 'text-black'; ?>">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
        ...
        <hr>
        <div class="dropdown">
            <a href="admin-panel.php" data-bs-toggle="dropdown"
            ...
            <ul class="dropdown-menu" data-bs-placement="top">
                ...
                <li><a href="admin-panel.php?logout=true" class="dropdown-item">خروج</a></li>
            </ul>
        </div>
    </div>
</div>
